...
> Mode: READ-ONLY
> Score: ~~22 / 100~~ → **65 / 100** (Wave 3A) → **70 / 100** (Wave 3A.5 UI wiring) → **78 / 100** (Wave 3B.1 archetype intake) — **STILL NOT PUBLIC-LAUNCH-READY** (per-archetype dashboards Wave 3B.2; `/partner/settings` rewrite Wave 3B.3; secret rotation pending end-of-remediation)
