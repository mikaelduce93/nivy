  ...
  return (
    <div className="border-t border-zinc-800 pt-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          <Label htmlFor="partner-password" className="text-zinc-300">
            Mot de passe *
          </Label>
          <Input
            id="partner-password"
        ...
        <div>
          <Label htmlFor="partner-password-confirm" className="text-zinc-300">
      ...
      {password.length > 0 && password.length < 8 && (
        <p className="text-xs text-red-400 mt-2">Minimum 8 caractères.</p>
      )}
