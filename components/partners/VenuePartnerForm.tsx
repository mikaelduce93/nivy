            ...
            <div key={step.id} className="flex items-center flex-1">
              <div className="flex flex-col items-center flex-1">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center border-2 transition-all ${
                  currentStep >= step.id
                    ? 'bg-pink border-pink text-ink'
                    : 'bg-card border-ink text-mute'
                }`}>
                  <step.icon className="w-6 h-6" />
                </div>
                <span className={`text-xs mt-2 text-center ${
                  currentStep >= step.id ? 'text-pink' : 'text-mute'
                }`}>
                  {step.title}
                </span>
              </div>
              {index < STEPS.length - 1 && (
                <div className={`h-0.5 flex-1 mx-2 transition-all ${
                  currentStep > step.id ? 'bg-pink' : 'bg-card'
                }`} />
              )}
            </div>
          ))}
      ...
      >
          ...
          <Card className="bg-card border-ink">
            <CardHeader>
              <CardTitle className="text-ink flex items-center gap-2">
                <Building2 className="w-5 h-5 text-pink" />
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="venueType" className="text-ink-2">
              ...
              {/* Amenities */}
              <div>
                <Label className="text-ink-2 mb-3 block">Équipements & Services</Label>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label htmlFor="hasParking" className="text-sm text-ink-2 cursor-pointer">
                      Parking
                    </label>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label htmlFor="hasWifi" className="text-sm text-ink-2 cursor-pointer">
                      WiFi gratuit
                    </label>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label htmlFor="hasOutdoorSeating" className="text-sm text-ink-2 cursor-pointer">
                      Terrasse
                    </label>
                  </div>
                </div>
              ...
              {/* Cuisine Types */}
              <div>
                <Label className="text-ink-2 mb-3 block">Types de cuisine</Label>
                <div className="grid md:grid-cols-4 gap-2">
                  {CUISINE_TYPES.map(type => (
                    <div key={type} className="flex items-center space-x-2">
                      ...
                      />
                      <label htmlFor={`cuisine-${type}`} className="text-sm text-ink-2 cursor-pointer">
                        {type}
                      </label>
                    </div>
                  ))}
              ...
              {/* Price Range */}
              <div>
                <Label htmlFor="priceRange" className="text-ink-2">
                  Gamme de prix
                </Label>
        ...
        {currentStep === 2 && (
          <Card className="bg-card border-ink">
            <CardHeader>
              <CardTitle className="text-ink flex items-center gap-2">
                <UtensilsCrossed className="w-5 h-5 text-pink" />
                Menu & Articles
              </CardTitle>
              <CardDescription className="text-mute">
            ...
            <CardContent className="space-y-6">
              ...
              {menuItems.map((item, index) => (
                <div key={item.id} className="p-4 bg-background rounded-lg border border-ink">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <Label className="text-ink-2">Nom du plat *</Label>
                      <Input
                        value={item.itemName}
                    ...
                    <div>
                      <Label className="text-ink-2">Catégorie</Label>
                      <Select
                        value={item.category}
                    ...
                    <div>
                      <Label className="text-ink-2 mb-3 block">Régime alimentaire</Label>
                      <div className="space-y-2">
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <label htmlFor={`${item.id}-vegetarian`} className="text-sm text-ink-2">
                            Végétarien
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <label htmlFor={`${item.id}-vegan`} className="text-sm text-ink-2">
                            Vegan
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <label htmlFor={`${item.id}-gluten`} className="text-sm text-ink-2">
                            Sans gluten
                          </label>
                        </div>
                      </div>
              ...
              <Button
                ...
                variant="outline"
                onClick={addMenuItem}
                className="w-full border-pink/50 text-pink hover:bg-pink/10"
              >
          ...
          <Card className="bg-card border-ink">
            ...
            <CardContent className="space-y-6">
              ...
              {eventPackages.map((pkg, index) => (
                <div key={pkg.id} className="p-4 bg-background rounded-lg border border-ink">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-ink font-medium">
                      Package {index + 1}
                    </h4>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <Label className="text-ink-2">Nom du package *</Label>
                      <Input
                    ...
                    <div>
                      <Label className="text-ink-2">Type</Label>
                      <Select
                    ...
                    <div>
                      <Label className="text-ink-2">Min. invités *</Label>
                      <Input
                        type="number"
                        value={pkg.minGuests}
                    ...
                    <div>
                      <Label className="text-ink-2">Max. invités *</Label>
                      <Input
                        type="number"
                        value={pkg.maxGuests}
                    ...
                    <div>
                      <Label className="text-ink-2">Prix/personne (DH) *</Label>
                      <Input
                        type="number"
                    ...
                    <div>
                      <Label className="text-ink-2">Durée (heures) *</Label>
                      <Input
                        type="number"
          ...
          <Card className="bg-card border-ink">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-4 bg-background rounded-lg">
                <h4 className="text-ink font-semibold mb-3">Établissement</h4>
                <div className="space-y-2 text-sm">
                  <p className="text-ink-2"><span className="text-mute">Nom:</span> {companyName}</p>
                  <p className="text-ink-2"><span className="text-mute">Type:</span> {venueType}</p>
              ...
              <div className="p-4 bg-background rounded-lg">
                <h4 className="text-ink font-semibold mb-3">Menu ({menuItems.length} articles)</h4>
                <div className="space-y-1">
                  {menuItems.slice(0, 3).map((item, idx) => (
                    <p key={item.id} className="text-sm text-ink-2">
                      {idx + 1}. {item.itemName || 'Sans nom'} - {item.basePrice} DH
                    </p>
                  ))}
                  {menuItems.length > 3 && (
                    <p className="text-xs text-mute">... et {menuItems.length - 3} autres</p>
                  )}
                </div>
              </div>

              <div className="p-4 bg-background rounded-lg">
                <h4 className="text-ink font-semibold mb-3">Packages événements ({eventPackages.length})</h4>
                <div className="space-y-1">
                  {eventPackages.map((pkg, idx) => (
                    <p key={pkg.id} className="text-sm text-ink-2">
      ...
      <div className="flex items-center justify-between mt-8">
        ...
        {currentStep < 4 ? (
          <Button
            ...
            className="bg-pink hover:bg-pink text-ink"
          >
            Suivant
