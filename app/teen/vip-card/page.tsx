...
const VIP_PERKS_USED = [
  { id: 1, perk: "Bonus XP 5%", usedCount: 45, icon: Percent },
  { id: 2, perk: "Accès récompenses", usedCount: 3, icon: Gift },
]

export default function VipCardPage() {
  // Mock user data
  const userXP = 2450
  const currentTier = VIP_TIERS.find(t => t.current)!
  const nextTier = VIP_TIERS.find(t => !t.current && t.xpRequired > 0)!
  const progressToNext = (userXP / nextTier.xpRequired) * 100
        ...
        <div className="relative z-10">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-amber-500/60 mt-2">Membre depuis Janvier 2024</p>
            </div>
