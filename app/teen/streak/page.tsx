...
import { Flame, Zap, Calendar, Trophy, Star, Gift, Target, TrendingUp, Check, Lock, Clock } from "lucide-react"
...
const STREAK_MILESTONES = [
  ...
  { days: 14, xpReward: 300, badge: "⚡", unlocked: false, title: "Électrique" },
  { days: 30, xpReward: 500, badge: "🌟", unlocked: false, title: "Étoile" },
  { days: 60, xpReward: 1000, badge: "🏆", unlocked: false, title: "Champion" },
  { days: 100, xpReward: 2000, badge: "👑", unlocked: false, title: "Légende" },
]

const STREAK_HISTORY = [
  { date: "2024-01-28", completed: true, xpEarned: 25 },
  { date: "2024-01-27", completed: true, xpEarned: 25 },
  { date: "2024-01-26", completed: true, xpEarned: 25 },
  { date: "2024-01-25", completed: true, xpEarned: 25 },
  { date: "2024-01-24", completed: true, xpEarned: 25 },
  { date: "2024-01-23", completed: true, xpEarned: 25 },
  { date: "2024-01-22", completed: true, xpEarned: 25 },
  { date: "2024-01-21", completed: false, xpEarned: 0 },
  { date: "2024-01-20", completed: true, xpEarned: 25 },
  { date: "2024-01-19", completed: true, xpEarned: 25 },
]

const DAILY_TASKS = [
  { id: 1, title: "Connexion quotidienne", completed: true, xp: 10 },
  { id: 2, title: "Compléter 1 quiz", completed: true, xp: 25 },
  { id: 3, title: "Gagner 50 XP", completed: true, xp: 15 },
  { id: 4, title: "Interagir avec un ami", completed: false, xp: 20 },
]
...
export default function StreakPage() {
  ...
  const bestStreak = 12
  const totalStreakXP = 575
  const streakMultiplier = 1.5

  const nextMilestone = STREAK_MILESTONES.find(m => !m.unlocked)
  const daysToNextMilestone = nextMilestone ? nextMilestone.days - currentStreak : 0

  const dailyProgress = DAILY_TASKS.filter(t => t.completed).length / DAILY_TASKS.length * 100
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-2 mt-4">
                ...
                <span className="text-orange-500 font-bold">x{streakMultiplier} multiplicateur XP actif!</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-8">
            ...
            <div className="p-4 rounded-2xl bg-black/20 text-center">
              <div className="flex items-center justify-center gap-2 mb-1">
                ...
                <span className="font-black text-xl">{STREAK_MILESTONES.filter(m => m.unlocked).length}</span>
              </div>
      ...
      <section className="space-y-4">
        ...
        <div className="p-6 rounded-3xl bg-zinc-900/50 border border-white/5">
          ...
          <div className="flex items-center justify-between mt-6 text-sm">
            <span className="text-zinc-500">10 derniers jours</span>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="text-right">
            <p className="font-black text-2xl text-gen-z-lavender">2</p>
