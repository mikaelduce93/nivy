...
export default function ReservationPaiementError({ error, reset }: ErrorProps) {
  useEffect(() => {
    captureError(error, {
      tags: { feature: 'reservation-paiement' },
    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4">
      <div className="relative z-10 max-w-lg w-full text-center">
        ...
        <p className="text-muted-foreground mb-3">
          Aucun montant n'a été débité. Vous pouvez réessayer ou contacter le support si le problème persiste.
        </p>
