    ...
    <main className="min-h-screen bg-background text-ink">
      <div className="container mx-auto px-4 py-12 max-w-3xl space-y-8">
        <header className="text-center space-y-4">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-lime/20 border border-lime/30">
            <Car className="w-8 h-8 text-lime" />
          </div>
        ...
        <Card className="bg-card border-ink">
          <CardHeader>
            <CardTitle className="text-ink">Pré-requis non négociables</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-card border-ink">
          <CardHeader>
            <CardTitle className="text-ink">Statut Wave 3B.1</CardTitle>
          </CardHeader>
        ...
        <Button asChild className="w-full h-12 bg-lime hover:bg-lime text-ink font-bold">
