/**
 * V1.2 — Parent reports a mentor session.
 *
 * POST /api/parent/mentor-sessions/:id/report
 *   body: {
 *     category: 'inappropriate' | 'late' | 'no_show' | 'safety',
 *     description?: string   // optional, ≤ 2000 chars
 *   }
 *
 * Auth: cookie session must be the linked parent of the teen on the session.
 */
...
export async function POST(req: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  // Ownership verification: caller must be a linked parent of the teen
